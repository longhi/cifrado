//creando un menu de cifrado
function menu(option) {
  //condicion cada opción
  (option === 1) ? cipher(): (option === 2) ? decipher() : (option === 3) ? alert('HASTA PRONTO') : alert('No existe esa opcion');
}
// Muestra  opciones para el usuario
do {
  var optMenu = 'BIENVENIDOS \n * Marca 1 para cifrar una frase \n * Marca 2 para descifrar una frase \n * Marca 3 para salir';
  //convierte a entero la opcion ingresada
  var option = parseInt(prompt(optMenu));
